...
define( 'YOURLS_DB_USER', 'yourlks' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'Winter11==maria' );
...
define( 'YOURLS_SITE', 'http://yourls.dmw.zone' );
...
define( 'YOURLS_COOKIEKEY', 'skjbjkdbfbsdeuhueifuefbenfkljeöafnaöelnnaöca' );
